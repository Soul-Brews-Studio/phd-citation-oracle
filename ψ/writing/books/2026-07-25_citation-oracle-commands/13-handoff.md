...
brief คุมได้แค่สิ่งที่ *ขอ* ไม่ได้คุมสิ่งที่ *ได้กลับมาจริง* — tool แต่งชื่อ paper ผิดได้ วางไว้ข้าง DOI ที่ถูก 100% จนตรวจด้วยตาเปล่าไม่เจอ (เคส Chen X. ข้างบน) ของที่ได้จาก Gemini หรือ GPT เชื่อไม่ได้ทั้งหมดจนผ่านการตรวจอีกรอบ — บทที่ 14 พาไปดูวิธีตรวจ
