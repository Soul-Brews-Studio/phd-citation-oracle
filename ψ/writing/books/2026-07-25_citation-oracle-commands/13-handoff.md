...
เช่นข้อสาม — แทนที่จะขอ "คำนวณ CCC ระหว่างเซนเซอร์กับ AOD" ให้ขอ "หา metric ที่ literature ใช้วัด agreement ระหว่างเซนเซอร์ราคาถูกกับ reference monitor และ threshold ที่ยอมรับได้" — ตอบได้จากสิ่งที่ paper รายงานไว้แล้ว ไม่ต้องคำนวณใหม่
...
สิบหกใบนี้คือของที่ tool จะไม่เสียเวลาหาซ้ำ เหลือแต่สิ่งที่ยังไม่มี (MODIS/MAIAC, VIIRS, TROPOMI, Himawari, MISR) — โฟกัสแคบลงเพราะบอกไว้ก่อนแล้ว
